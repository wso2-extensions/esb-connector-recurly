...
- Initiate Subscription
   ...
   Case-003 ->
         ...
         Pre Requisite:	Contacts in BaseCRM should have first name, last name, Email, Billing Information and visa card number recorded                          in description field like "Card Number :4111-1111-1111-1111". Accounts that are already created on Recurly must                          have billing info. If phone number is needed it specified in work field under the phone section.  
         Note         :	In the request Recurly account codes of existing accounts and Base CRM contact Ids which is used to create                               account in Recurly should be added in to the recurlyAccounts parameter.
	 Reference    : Scenario Guide Document -> Chapter 3.1 -> Initiate Subscription
